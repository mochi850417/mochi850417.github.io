...
!(function(t) {
  ...
  function(t) {
    ...
    (k.Widget.prototype = {
      ...
      _trigger: function(t, e, i) {
        ...
        if (
          ((i = i || {}),
          ((e = k.Event(e)).type = (t === this.widgetEventPrefix
            ? t
      ...
      return (
        ...
        k.each(['my', 'at'], function() {
          ...
          1 === i.length &&
            (i = o.test(i[0])
              ? i.concat(['center'])
              : a.test(i[0]) ? ['center'].concat(i) : ['center', 'center']),
      ...
      fit: {
        left: function(t, e) {
          ...
          e.collisionWidth > n
            ...
            : 0 < a
              ? (t.left += a)
              : 0 < r ? (t.left -= r) : (t.left = x(t.left - o, t.left));
        },
        top: function(t, e) {
          var i = e.within,
          ...
          e.collisionHeight > n
            ...
            : 0 < a
              ? (t.top += a)
              : 0 < r ? (t.top -= r) : (t.top = x(t.top - o, t.top));
        },
      },
      flip: {
        left: function(t, e) {
    ...
    return 'area' === a
      ? ((s = (i = t.parentNode).name),
        !(!t.href || !s || 'map' !== i.nodeName.toLowerCase()) &&
          (0 < (s = k("img[usemap='#" + s + "']")).length && s.is(':visible')))
      ...
      start: function() {
        var i,
          ...
          a =
            o instanceof k
              ? o.get(0)
              : /parent/.test(o) ? e.parent().get(0) : o;
        a &&
    ...
    k.widget('ui.sortable', k.ui.mouse, {
          ...
          (!this.options.disabled &&
            ...
            !!i &&
              (!(
                this.options.handle &&
                !e &&
                (k(this.options.handle, i).find('*').addBack().each(function() {
                  this === t.target && (s = !0);
                }),
                !s)
              ) &&
      ...
      serialize: function(e) {
        ...
        return (
          (e = e || {}),
          k(t).each(function() {
            var t = (k(e.item || this).attr(e.attribute || 'id') || '')
      ...
      _move: function(t, e, i) {
        ...
        this.active &&
          (s =
            'first' === t || 'last' === t
              ? this.active
                  ['first' === t ? 'prevAll' : 'nextAll']('.ui-menu-item')
                  .eq(-1)
    ...
    k.extend(v.prototype, {
      ...
      _optionDatepicker: function(t, e, i) {
        ...
        if (2 === arguments.length && 'string' == typeof e)
          return 'defaults' === e
            ...
            : r
              ? 'all' === e ? k.extend({}, r.settings) : this._get(r, e)
              : null;
        (s = e || {}),
      ...
      _selectDay: function(t, e, i, s) {
        ...
        k(s).hasClass(this._unselectableClass) ||
          ...
          (((n = this._getInst(n[0])).selectedDay = n.currentDay = k(
            'a',
            s,
          ).html()),
  ...
  function tt(t, e, i) {
    ...
    return null == t
      ...
      : ((t = s.floor ? ~~t : parseFloat(t)),
        isNaN(t)
          ? e.def
          : s.mod ? (t + s.mod) % s.mod : t < 0 ? 0 : s.max < t ? s.max : t);
  }
  function et(s) {
    var n = N(),
      o = (n._rgba = []);
  ...
  function nt(t, e, i, s) {
    return (
      ...
      (t.duration = k.fx.off
        ...
        : 'number' == typeof i
          ? i
          : i in k.fx.speeds ? k.fx.speeds[i] : k.fx.speeds._default),
  ...
  function ot(t) {
    return (
      ...
      (('string' == typeof t && !k.effects.effect[t]) ||
        (k.isFunction(t) || ('object' == typeof t && !t.effect)))
    );
  }
  function at(t, e) {
    var i = e.outerWidth(),
  ...
  (k.effects = { effect: {} }),
    ...
    k.expr &&
      ...
      (k.expr.filters.animated = ((K = k.expr.filters.animated),
      function(t) {
